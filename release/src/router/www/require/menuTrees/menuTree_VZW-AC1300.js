	...
	var menuTree = {
		list: [
			...
			*/
			...
			{
				menuName: "Client List",
				index: "menu_Setting",
				tab: [
					{url: "index.asp", tabName: "Clients"},
					{url: "NULL", tabName: "__INHERIT__"}
				] 
			},
			{
		...
		exclude: {
			...
			tabs: function(){
				...
				if(lyra_hide_support){
					...
					retArray.push("Advanced_GWStaticRoute_Content.asp");
					retArray.push("Advanced_ASUSDDNS_Content.asp");
					retArray.push("Advanced_NATPassThrough_Content.asp");
					retArray.push("Advanced_SettingBackup_Content.asp");
					retArray.push("Advanced_Feedback.asp");
					retArray.push("Main_RouteStatus_Content.asp");
					retArray.push("Main_ConnStatus_Content.asp");
					retArray.push("Advanced_IPTV_Content.asp");
